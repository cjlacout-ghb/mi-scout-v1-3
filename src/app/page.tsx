...
export default function LineupPage() {
  ...
  const [confirmandoEliminarBateador, setConfirmandoEliminarBateador] = useState<Bateador | null>(null);
    ...
    <div style={{ paddingBottom: 80 }}>
                ...
                <div
                  ...
                  onClick={() => {
                    if (estado.partido?.finalizado) {
                      ...
                      router.push(`/stats?verPartido=${estado.partido.id}&verJugador=${b.id}&verEquipo=${activeTab}`);
                      return;
                    }
                  ...
                  {!estado.partido?.finalizado && (
                    <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
                      <button
                        ...
                        style={{ padding: 6, border: 'none', color: 'var(--text-secondary)' }}
                        onClick={(e) => {
                          e.stopPropagation();
                          setEditando(b);
                        }}
                      ...
                      <button
                        style={{
                          ...
                          cursor: 'pointer', fontSize: '1.2rem', padding: '0 4px', opacity: 0.7
                        }}
                        onClick={(e) => {
                          e.stopPropagation();
                          setConfirmandoEliminarBateador(b);
                        }}
                      >
                        ✕
                      </button>
      ...
      {confirmandoEliminarBateador && (
        <ModalConfirm
          ...
          onCancelar={() => setConfirmandoEliminarBateador(null)}
        />
      )}
    </div>
  );
